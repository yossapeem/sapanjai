...
for epoch in range(EPOCHS):
    ...
    if val_macro_f1 > best_val_f1:
        ...
        torch.save(model_for_training.state_dict(), 'Sapanjai Backend/best_goemotions_model.pt')
...
model_for_training.load_state_dict(torch.load('Sapanjai Backend/best_goemotions_model.pt')) # Load best model
